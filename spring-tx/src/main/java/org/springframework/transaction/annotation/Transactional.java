 ...
 *
 * 注解类型通常可以直接与Spring的{@link org.springframework.transaction.interceptor.RuleBasedTransactionAttribute}类进行比较
 * 实际上，{@link AnnotationTransactionAttributeSource}会直接将数据转换为后一类，Spring的事务可以以此来支持。
